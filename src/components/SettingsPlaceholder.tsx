  ...
  return (
    <div className="mt-5 space-y-4 max-w-3xl">
      <div className="relative rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-gray-500/5 via-transparent to-gray-400/5 pointer-events-none" />
        ...
        <div className="relative text-center py-8">
          ...
          <div className="mt-6 flex items-center justify-center gap-2 text-xs text-white/50">
            ...
            <span>{t("settings.placeholder.hint")}</span>
          </div>
        </div>
      </div>
    </div>
